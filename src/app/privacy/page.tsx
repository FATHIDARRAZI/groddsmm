      ...
      <div className="w-full glass-panel rounded-[2rem] p-8 md:p-12 relative overflow-hidden dir-rtl text-right">
        ...
        <div className="relative z-10 space-y-6">
          ...
          <div className="text-slate-300 space-y-6 leading-relaxed">
            ...
            <p>
              تستخدم منصتنا ملفات تعريف الارتباط وتقنيات التتبع المماثلة لتحسين تجربتك. كما أننا نجعل هذه الأداة مجانية للجميع من خلال الاعتماد على الإعلانات (مثل Google AdSense). قد تستخدم جهات خارجية، بما في ذلك Google، ملفات تعريف الارتباط لعرض إعلانات بناءً على زياراتك السابقة لموقعنا أو مواقع أخرى على الإنترنت.
            </p>
            <p>
              يمكن للمستخدمين إلغاء الاشتراك في عرض الإعلانات المخصصة من خلال زيارة <a href="https://myadcenter.google.com/" target="_blank" rel="noopener noreferrer" className="text-pink-500 hover:underline">إعدادات الإعلانات من Google</a>.
            </p>
